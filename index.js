...
$(document).ready(function() {
    $('.dropdown-item').on("click", function() {
        ...
        if ($(this).is('#Windows7_32bit')){
            ...
            "<li class=\'list-group-item\'><a href=\'" + basePathSetups + bit32Path + pathChrome + "\'><div class='\image-wrapper'\><img src=\'" + basePathPhotos + chromeSetupImg + "\'></img></div><br>" + chromeDesc + "</div></a></li>" +
            "<li class=\'list-group-item\'><a href=\'" + basePathSetups + bit32Path + pathVLC + "\'><div class='\image-wrapper'\><img src=\'" + basePathPhotos + vlcImg + "\'></img></div><br>" + vlcDesc + "</div></a></li>" +
            "<li class=\'list-group-item\'><a href=\'" + basePathSetups + bit32Path + pathWinrar + "\'><div class='\image-wrapper'\><img src=\'" + basePathPhotos + winrarImg + "\'></img></div><br>" + winrarDesc + "</div></a></li>" +
            "<li class=\'list-group-item\'><a href=\'" + basePathSetups + bit32Path + pathEset + "\'><div class='\image-wrapper'\><img src=\'" + basePathPhotos + esetImg + "\'></img></div><br>" + esetDesc + "</div></a></li>" +
            "<li class=\'list-group-item\'><a href=\'" + basePathSetups + bit32Path + pathRadmin + "\'><div class='\image-wrapper'\><img src=\'" + basePathPhotos + radminImg + "\'></img></div><br>" + radminDesc + "</div></a></li>" +
            "<li class=\'list-group-item\'><a href=\'" + basePathSetups + bit32Path + pathRadminCrack + "\'><div class='\image-wrapper'\><img src=\'" + basePathPhotos + radmincrackImg + "\'></img></div><br>" + radminCrackDesc + "</div></a></li>" +
            "<li class=\'list-group-item\'><a href=\'" + basePathSetups + bit32Path + pathOffice + "\'><div class='\image-wrapper'\><img src=\'" + basePathPhotos + officeImg + "\'></img></div><br>" + officeDesc + "</div></a></li>" +
            "<li class=\'list-group-item\'><a href=\'" + basePathSetups + bit32Path + pathFirefox + "\'><div class='\image-wrapper'\><img src=\'" + basePathPhotos + firefoxImg + "\'></img></div><br>" + firefoxDesc + "</div></a></li>" +
            "<li class=\'list-group-item\'><a href=\'" + basePathSetups + bit32Path + pathNitro + "\'><div class='\image-wrapper'\><img src=\'" + basePathPhotos + nitroImg + "\'></img></div><br>" + nitroDesc + "</div></a></li>" +
            "<li class=\'list-group-item\'><a href=\'" + basePathSetups + bit32Path + pathNitroKeygen + "\'><div class='\image-wrapper'\><img src=\'" + basePathPhotos + nitroKeygenImg + "\'></img></div><br>" + nitroKeygenDesc + "</div></a></li>" +
            "</ul></div>");   
        }
        else{
            $('#Programs').empty();
